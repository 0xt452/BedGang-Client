...
public class Modules extends System<Modules> {
    ...
    public void init() {
        ...
        initWorld();
        initMisc();
        add(new meteordevelopment.meteorclient.systems.modules.phobos.ArmorMessage());
        add(new meteordevelopment.meteorclient.systems.modules.phobos.AntiTrap());
        add(new meteordevelopment.meteorclient.systems.modules.phobos.AntiVanish());
        add(new meteordevelopment.meteorclient.systems.modules.phobos.FastSwim());
        add(new meteordevelopment.meteorclient.systems.modules.phobos.StairSpeed());
        add(new meteordevelopment.meteorclient.systems.modules.phobos.Ranges());
        add(new meteordevelopment.meteorclient.systems.modules.phobos.PingSpoof());
        add(new meteordevelopment.meteorclient.systems.modules.phobos.Companion());
        add(new meteordevelopment.meteorclient.systems.modules.phobos.Tracker());
        add(new meteordevelopment.meteorclient.systems.modules.phobos.OffscreenESP());
        add(new meteordevelopment.meteorclient.systems.modules.phobos.AutoGG());
        add(new meteordevelopment.meteorclient.systems.modules.phobos.PhobosGui());
        add(new meteordevelopment.meteorclient.systems.modules.phobos.PhobosHud());
        meteordevelopment.meteorclient.systems.modules.impact.ImpactRegistry.register(this);
    }
