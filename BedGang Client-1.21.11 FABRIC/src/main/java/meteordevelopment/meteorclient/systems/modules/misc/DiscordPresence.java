...
public class DiscordPresence extends Module {
    ...
    private final Setting<List<String>> line2Strings = sgLine2.add(new StringListSetting.Builder()
        ...
        .defaultValue("BedGang | t4's edition", "{round(server.tps, 1)} TPS", "Playing on {server.difficulty} difficulty.", "{server.player_count} Players online")
    ...
    public DiscordPresence() {
        super(Categories.Misc, "discord-presence", "Displays t4's BedGang edition in Discord presence details.");
    ...
    public void onActivate() {
        ...
        currentSmallImage = SmallImage.Owner;
    ...
    private enum SmallImage {
        Group("meteor_client", "BedGang"),
        Owner("meteor_client", "t4");
