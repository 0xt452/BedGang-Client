...
public class Categories {
    ...
    public static final Category PhobosPort = new Category("Phobos Port", Items.END_CRYSTAL.getDefaultStack());
    ...
    public static void init() {
        ...
        Modules.registerCategory(PhobosPort);
        Modules.registerCategory(meteordevelopment.meteorclient.systems.modules.impact.ImpactRegistry.CATEGORY);
